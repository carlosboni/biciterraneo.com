...
class LNE_JSAnimationFileCache extends SYWHeaderFilesCache
{
	public function __construct($extension, $params = null)
	{
		...
		$show_errors = ($params->get('show_errors', '') == '') ? JComponentHelper::getParams('com_latestnewsenhancedpro')->get('show_errors', 0) : $params->get('show_errors', '');
		...
		$pagination_size = '';
		if ($pagination_style) { // Bootstrap is selected
