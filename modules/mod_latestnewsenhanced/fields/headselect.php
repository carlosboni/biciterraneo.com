...
class JFormFieldHeadSelect extends \JFormFieldList
{
	...
	protected function getOptions()
	{
		...
		$options[] = HTMLHelper::_('select.option', 'author', Text::_('MOD_LATESTNEWSENHANCEDEXTENDED_VALUE_AUTHORCONTACT'), 'value', 'text', $disable = true);
		if (SYWK2::exists()) {
			$options[] = HTMLHelper::_('select.option', 'authork2user', Text::_('MOD_LATESTNEWSENHANCEDEXTENDED_VALUE_AUTHORK2USER'), 'value', 'text', $disable = true);
		}
