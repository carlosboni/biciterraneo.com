		...
		<div class="contact-plain">
			<?php if ($this->contact->misc && $tparams->get('show_misc')) : ?>
				<div class="map-content">
					<div class="row">
						<div class="col-xs-12">
							<?php echo '<h3><span>' . JText::_('TPL_CONTACT_OTHER_INFORMATION') . '</span></h3>'; ?>
						    <div class="contact-miscinfo">
						      <dl class="dl-horizontal">
						        <dt>
						          <span class="<?php echo $tparams->get('marker_class'); ?>">
					...
					<div class="contact-left">
						<?php if ($tparams->get('show_email_form') && ($this->contact->email_to || $this->contact->user_id)) : ?>
							<div class="content-form-email">
								<?php echo '<h3><span>' . JText::_('COM_CONTACT_EMAIL_FORM') . '</span></h3>'; ?>
				...
				<div class="col-md-4">
					<div class="contact-right">
						<div class="contact-us-content">
							<?php echo '<h3><span>' . JText::_('TPL_CONTACT_US') . '</span></h3>'; ?>

							<!-- Image -->
						    <?php if ($this->contact->image && $tparams->get('show_image')) : ?>
						      <div class="thumbnail pull-right">
						        <?php echo JHtml::_('image', $this->contact->image, " ", array('itemprop' => 'image')); ?>
						      </div>
						    <?php endif; ?>
